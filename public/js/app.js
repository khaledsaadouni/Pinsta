...
const b = document.getElementById("fl")
a.addEventListener("click", (e) => {
    if (b.innerText == "Follow") {
        a.classList = "btn btn-outline-danger"
        a.innerHTML = "<i class=\"bi bi-person-x\"></i>&nbsp;&nbsp;<span id=\"fl\">Following</span>"

    } else {
        a.classList = "btn btn-danger"

        a.innerHTML = "<i class=\"bi bi-person-plus\"></i>&nbsp;&nbsp;<span id=\"fl\">Follow</span>"
    }
})
